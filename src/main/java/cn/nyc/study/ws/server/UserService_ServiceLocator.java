/**
 * UserService_ServiceLocator.java
 *
...
public class UserService_ServiceLocator extends org.apache.axis.client.Service implements cn.nyc.study.ws.server.UserService_Service {

    public UserService_ServiceLocator() {
    }


    public UserService_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public UserService_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for UserServiceImplPort
    private java.lang.String UserServiceImplPort_address = "http://localhost:8080/soap/user";
    ...
    public cn.nyc.study.ws.server.UserService_PortType getUserServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.nyc.study.ws.server.UserServiceSoapBindingStub _stub = new cn.nyc.study.ws.server.UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.nyc.study.ws.server.UserService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.nyc.study.ws.server.UserServiceSoapBindingStub _stub = new cn.nyc.study.ws.server.UserServiceSoapBindingStub(new java.net.URL(UserServiceImplPort_address), this);
                _stub.setPortName(getUserServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.ws.study.nyc.cn/", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.ws.study.nyc.cn/", "UserServiceImplPort"));
        }
